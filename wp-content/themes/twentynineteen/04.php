...
<?php
/*
  Template Name: Clubes e Universidades
*/
  ...
  <head>
    ...
    <style type="text/css">
         header {
          ...
          position: relative;
          background-image: url("/wp_atletasnow/wp-content/themes/twentynineteen/new_style/img/img-destaque-clubes.png");
        }
    </style>
...
você só encontra na AtletasNow.</h5>
  ...
  background-image: linear-gradient(98deg, #ff5f00, #a0002a);">Cadastre-se no AtletasNow</button>
                </div>
