...
<html lang="en">
  <head>
    ...
    <title>AtletasNow - Modalidade Golfe</title>
    ...
    <style type="text/css">
         header {
          ...
          position: relative;
          background-image: url("https://www.fundoswiki.com/Uploads/fundoswiki.com/ImagensGrandes/taco-e-bola-de-golfe.jpg");
        }
    </style>
            ...
            <div class="col-md-4">
             ...
             <div class="col-md-4">
              ...
              <div  style="
                ...
                letter-spacing: -0.1px;
                text-align: center;
                color: #4a4a4a;">Total de Tacadas</span>
             ...
             <div class="col-md-4">
              ...
              <div  style="
                ...
                color: #4a4a4a;">Maior Pontuação</span>
...
descontos esclusivos</h4>
  ...
  <div class="col-md-12 section-1">
    ...
    conteúdos e descontos exclusivos.</p>
                 <a href="http://www.atletasnow.com/app/cadastro"> <button class="btn m-3">Cadastre-se no AtletasNow</button> </a>
              </div>
