...
<?php
/*
  Template Name: Modalidade Tenis 2
*/
...
<html lang="en">
  <head>
    ...
    <title>AtletasNow - Modalidade Tenis</title>
    ...
    <style type="text/css">
         header {
          ...
          position: relative;
          background-image: url("https://www.setaswall.com/wp-content/uploads/2017/06/Tennis-Wallpapers-21-2048-x-1257-768x471.jpg");
        }
    </style>
      ...
      <div class="row p-5">
        ...
        <div class="col-md-12 text-center mt-5">
          <!-- <h1>As melhores oportunidades para os melhores atletas.</h1> -->
           <h1>Estatísticas de Tênis no Brasil</h1>
