...
*/
	...
	while(have_posts()): the_post();
	  ...
	  #Getting meta values...
	  $page_layout = "";
	  if(is_tax('tribe_events_cat')) $page_layout = whistle_option('events', 'event-category-layout');
	  elseif(in_array('events-single', get_body_class())) $page_layout = whistle_option('events', 'event-detail-layout');
	  elseif(in_array('events-archive', get_body_class())) $page_layout = whistle_option('events', 'event-archive-layout');
	  else $page_layout = whistle_option('events', 'event-archive-layout');
          ...
          <div class="container">
              ...
              <?php endif; ?>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>><?php
                    the_content();
                    wp_link_pages(array('before' => '<div class="page-link"><strong>'.__('Pages:', 'whistle').'</strong> ', 'after' => '</div>', 'next_or_number' => 'number'));
                    edit_post_link(__('Edit', 'whistle'), '<span class="edit-link">', '</span>' ); ?>
                </article>
              </section>
