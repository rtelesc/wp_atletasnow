...
<link rel='stylesheet' id='redux-google-fonts-startos_option-css'  href='http://fonts.googleapis.com/css?family=Montserrat%3A300&#038;ver=1550572742' type='text/css' media='all' />
 ...
 -->
  ...
  color: #ffffff;
  font-weight: 600;
">Informações atualizadas sobre atletas
você só encontra na AtletasNow.</h5>
  ...
  background-image: linear-gradient(98deg, #ff5f00, #a0002a);">Cadastre-se no AtletasNow</button></a>
                </div>
      ...
      <div class="row p-5">
        ...
        <div class="col-md-12 text-center mt-5">
          ...
          <div class="row m-5">
            ...
            <div class="col-md-4">
              <img src="/wp-content/themes/whistle/new_style/img/01.png">
...
e atletas vinculados</h4>
            ...
            <div class="col-md-4">
              <img src="/wp-content/themes/whistle/new_style/img/02.png">
              <h4 style="font-family: Axiforma;
  font-size: 20px;
  font-weight: 600;
  font-style: normal;
...
os atletas </h4>
            ...
            <div class="col-md-4">
              <img src="/wp-content/themes/whistle/new_style/img/03.png">
              <h4 style="font-family: Axiforma;
  font-size: 20px;
  font-weight: 600;
  font-style: normal;
...
de atletas</h4>
          ...
          <div class="row m-5">
            ...
            <div class="col-md-4">
              <img src="/wp-content/themes/whistle/new_style/img/04.png">
              <h4 style="font-family: Axiforma;
  font-size: 20px;
  font-weight: 600;
  font-style: normal;
  ...
  letter-spacing: -0.1px;
  text-align: center;
  color: #4a4a4a;">Publicação de
comunicados oficiais</h4>
            </div> 

            <div class="col-md-4">

              <img src="/wp-content/themes/whistle/new_style/img/05.png">
              <h4 style="font-family: Axiforma;
  font-size: 20px;
  font-weight: 600;
  font-style: normal;
...
todos os atletas </h4>
            ...
            <div class="col-md-4">
              <img src="/wp-content/themes/whistle/new_style/img/06.png">
              <h4 style="font-family: Axiforma;
  font-size: 20px;
  font-weight: 600;
  font-style: normal;
