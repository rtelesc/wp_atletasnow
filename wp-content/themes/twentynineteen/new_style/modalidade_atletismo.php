...
<?php
/*
  Template Name: Modalidade  Atletismo
  */
...
<html lang="en">
  <head>
    ...
    <title>AtletasNow - Modalidade Atletismo</title>
    ...
    <style type="text/css">
         header {
          ...
          position: relative;
          background-image: url("https://images4.alphacoders.com/285/thumb-1920-285874.jpg");
        }
    </style>
          ...
          <div class="row">
            ...
            <div class="col-md-4 mt-4">
              ...
              <div  style="
                ...
                letter-spacing: -0.1px;
                text-align: center;
                color: #4a4a4a;">Melhor Marca da Temporada</span>
             ...
             <div class="col-md-4 mt-4">
              ...
              <div  style="
                ...
                letter-spacing: -0.1px;
                text-align: center;
                color: #4a4a4a;">Quantidade de Provas</span>
             ...
             <div class="col-md-4 mt-4">
              ...
              <div  style="
                ...
                color: #4a4a4a;">Quantidade de Pontos</span>
