...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/style_erro_page.css">
    ...
    <style type="text/css">
         header {
          ...
          position: relative;
          background-image: url("img/img-destaque-corredora.png");
        }
    </style>
