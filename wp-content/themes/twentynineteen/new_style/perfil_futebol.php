  ...
  <head>
    ...
    <style type="text/css">
         header {
          ...
          position: relative;
          background-image: url("/wp-content/themes/whistle/new_style/img/img-destaque-futebol@2x.png");
        }
    </style>
...
<link rel='stylesheet' id='redux-google-fonts-startos_option-css'  href='http://fonts.googleapis.com/css?family=Montserrat%3A300&#038;ver=1550572742' type='text/css' media='all' />
 ...
 -->
                ...
                <div class="col-md-6 mt-5 text-right">
                  ...
                  color: #ffffff;">Marcos Rocha</h1>

                  <button class="btn btn-atleta pull-right">Sou Atleta Profissional</button> <span style=" width: 390px;
  height: 16px;
  font-family: Axiforma;
  font-size: 16px;
  font-weight: 600;
  ...
  color: #ffffff;">Verifique seu perfil e tenha benefícios exclusivos.</span>
                </div>


                <div class="col-md-4 mt-5">
                  <div class="input-group mt-3">
                    <input type="text" class="form-control input_search" placeholder="Digite o nome do atleta ou modalidade">
                    <div class="input-group-append">
                      <button style="" class="btn btn-largee" type="button">
...
global $wp;
                ...
                <div class="col-md-12 text-center mt-5">
                 <a href="https://www.atletasnow.com/app/cadastro/"> <button class="btn" style="font-family: Axiforma;
  font-size: 16px;
  font-weight: 600;
  font-style: normal;
  font-stretch: normal;
  ...
  letter-spacing: -0.1px;
  text-align: center;
  color: #ffffff;border-radius: 22.5px;
  background-image: linear-gradient(98deg, #ff5f00, #a0002a);">Você é <?php echo $_GET['pesquisa']; ?>? Cadastre-se</button></a>
                </div>
