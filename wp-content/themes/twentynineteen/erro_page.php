...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/wp_atletasnow/wp-content/themes/twentynineteen/new_style/assets/css/style_erro_page.css">
    ...
    <style type="text/css">
         header {
          ...
          position: relative;
          background-image: url("/wp_atletasnow/wp-content/themes/twentynineteen/new_style/img/img-destaque-corredora.png");
        }
    </style>
...
<link rel='stylesheet' id='redux-google-fonts-startos_option-css'  href='http://fonts.googleapis.com/css?family=Montserrat%3A300&#038;ver=1550572742' type='text/css' media='all' />
 ...
 -->
  ...
  color: #ffffff;">Flavia Chanso</h1>
                ...
                <div class="col-md-12 mt-5">
                  <h1 class="h1_02">Este atleta ainda não está na AtletasNow.</h1>
                </div>
  ...
  background-image: linear-gradient(98deg, #ff5f00, #a0002a);">Você é Flávia Chonso? Cadastre-se</button>
                </div>
